...
session_start();
require_once 'db.php';
$query = "select * from tblproduct WHERE kategory='tophat'";
$d = $conn->query($query);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Gentleshats | Category</title>
...
<div class="container">
    <div class="row">
        <div class="col-3"> <a href="CategoryList.php" class="btn">All</a>
                            <a href="CategorySuit.php" class="btn">Suit</a>
                            <a href="CategoryBoots.php" class="btn">Boots</a>
